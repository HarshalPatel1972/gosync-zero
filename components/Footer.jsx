...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    Resources: [
      ...
      { label: "GitHub", href: "https://github.com/HarshalPatel1972/GoSync", external: true },
    ],
    Legal: [
      { label: "MIT License", href: "https://github.com/HarshalPatel1972/GoSync/blob/main/LICENSE", external: true },
      { label: "Contributing", href: "https://github.com/HarshalPatel1972/GoSync/blob/main/CONTRIBUTING.md", external: true },
    ],
  };
